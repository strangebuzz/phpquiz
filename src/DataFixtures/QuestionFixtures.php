...
class QuestionFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public const DATA = [
        ...
        [
            ...
            /*'differences_output_notes' =>*/ 'For PHP 7, the right answer is "C" (there was an error the original Twitter poll).',
        ...
        [
            ...
            /*'answer_explanations'      =>*/ 'PHP magic setters do not follow strict_types and you can set a property which does not exist. PHP 8 will not change this behavior. The right answer was "A".',
        ...
        [
            ...
            /*'person_id'                =>*/ 1,
            /*'difficulty_id'            =>*/ 3,
            /*'label'                    =>*/ 'WTF PHP 8 quiz: What will be displayed?',
            ...
            /*'answer_explanations'      =>*/ 'Yes, PHP 8 always has alternative syntax for control structures, and you can mix them. "goto" was introduced in PHP 5.3 and it still exists in version 8. This is not a good practice, please do not use it. This quiz is a joke! The right answer was "fooend" (B).',
        ...
        [
            ...
            /*'answer_explanations'      =>*/ 'Default value of unset variable is "NULL".  Then type must be nullable even when it s a reference. The right answer was a fatal TypeError.',
