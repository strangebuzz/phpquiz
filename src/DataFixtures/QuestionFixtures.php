...
class QuestionFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private const DATA = [
        ...
        [
            ...
            /*'answer_explanations'      =>*/ 'PHP function "property_exists" will find the private property, but you cannot access to it. The right answer was "C".',
        ...
        [
            ...
            /*'answer_explanations'      =>*/ 'The PHP function <code>array_merge</code> reorders numeric keys, thus the 42 key is renamed to 0, the right answers was "C".',
